                ...
                <div class="card-body">
                    <form action="servletLogin" method="post">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Boleta</label>
                            <input class="form-control" id="exampleInputEmail1" name="email" type="text" aria-describedby="emailHelp" required placeholder="Enter boleta">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="text-center">
                        <p>Pida a su profesor que lo registre si es que no tiene una cuenta</p>
